...
<body>
    <div id="wrap">
        <header>
            ...
            <!--로고 들어가는 곳-->
            <div id="logo">
                <img src="images/logo.jpg" width="265" height="62">
            </div>
            ...
            <div id="s3slider">
                <ul id="s3sliderContent">
                    <li class="s3sliderImage">
                       <img src="images/car1.jpg" width="971" height="282">
                       <span>
                    ...
                    <li class="s3sliderImage">
                        <img src="images/car2.jpg" width="971" height="282">
                       <span>
                           로렘 ipsum dolor sit amet, consecteur adipiscing elit. Nullam semper eratest<br>
                           Aloiquam metus elit, blandit eu luctus vitae, dictum ist amet mauris. Integerut facilisis eros<br>
                           Donec consectetur, velit id aliquam sagittis.
                    ...
                    <li class="s3sliderImage">
                        <img src="images/car3.jpg" width="971" height="282">
                       <span>
                           로렘 ipsum dolor sit amet, consecteur adipiscing elit. Nullam semper eratest<br>
                           Aloiquam metus elit, blandit eu luctus vitae, dictum ist amet mauris. Integerut facilisis eros<br>
                           Donec consectetur, velit id aliquam sagittis.
                    ...
                    <li class="s3sliderImage">
                        <img src="images/car4.jpg" width="971" height="282">
                       <span>
                           로렘 ipsum dolor sit amet, consecteur adipiscing elit. Nullam semper eratest<br>
                           Aloiquam metus elit, blandit eu luctus vitae, dictum ist amet mauris. Integerut facilisis eros<br>
                           Donec consectetur, velit id aliquam sagittis.
